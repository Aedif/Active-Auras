...
export async function extendEffectsForm(sheet, html) {
  ...
  const customCheck = flags[CONSTANTS.MODULE_NAME]?.customCheck ? flags[CONSTANTS.MODULE_NAME]?.customCheck : "";
    ...
    <div class="tab" data-tab="ActiveAuras">
        ...
        <div id="specifics">
            ...
            <div class="form-group">
              ...
              <input id="type" name="flags.${CONSTANTS.MODULE_NAME}.customCheck" type="text" value="${customCheck}" placeholder="JavaScript"></input>
            </div>
            <div class="form-group">
